...
- Browser layout editor controls for panel size/background and selected-widget sensor/label/font/icon/lock settings, with click-to-select, drag-to-move, resize handles, duplicate/delete actions, lock-respecting edits, and browser-local autosave
