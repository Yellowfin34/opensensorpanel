...
- Browser layout editor controls for panel size/color/background image and selected-widget sensor/label/font/icon/lock settings, with click-to-select, drag-to-move, resize handles, duplicate/delete actions, grid/alignment snapping, undo/redo, named local templates, lock-respecting edits, and browser-local autosave
